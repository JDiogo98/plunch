...
export const GlobalContextProvider = ({ children }) => {
  const [meals, setMeals] = useState<MealList>(teste);

  async function searchMeals(term: string) {
    try {
  ...
  return (
    <GlobalContext.Provider value={{ meals, setMeals, searchMeals }}>
      {children}
